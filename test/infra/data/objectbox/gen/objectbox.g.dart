...
final _entities = <obx_int.ModelEntity>[
  obx_int.ModelEntity(
    id: const obx_int.IdUid(1, 3680107222965857929),
    name: 'EntityBMMock',
    lastPropertyId: const obx_int.IdUid(4, 111424812052769067),
    flags: 0,
    properties: <obx_int.ModelProperty>[
      obx_int.ModelProperty(
        id: const obx_int.IdUid(1, 2795414727038229468),
        name: 'id',
        type: 6,
        flags: 1,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(2, 6398995127646150083),
        name: 'createdAt',
        type: 10,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(3, 2593813191657308756),
        name: 'updatedAt',
        type: 10,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(4, 111424812052769067),
        name: 'sillyProp',
        type: 9,
        flags: 0,
      ),
...
obx_int.ModelDefinition getObjectBoxModel() {
  final model = obx_int.ModelInfo(
    ...
    entities: _entities,
    lastEntityId: const obx_int.IdUid(1, 3680107222965857929),
  ...
  final bindings = <Type, obx_int.EntityDefinition>{
    EntityBMMock: obx_int.EntityDefinition<EntityBMMock>(
      model: _entities[0],
      toOneRelations: (EntityBMMock object) => [],
      toManyRelations: (EntityBMMock object) => {},
      getId: (EntityBMMock object) => object.id,
      setId: (EntityBMMock object, int id) {
        object.id = id;
      },
      objectToFB: (EntityBMMock object, fb.Builder fbb) {
        final sillyPropOffset = fbb.writeString(object.sillyProp);
        fbb.startTable(5);
        fbb.addInt64(0, object.id);
        fbb.addInt64(1, object.createdAt?.millisecondsSinceEpoch);
        fbb.addInt64(2, object.updatedAt?.millisecondsSinceEpoch);
        fbb.addOffset(3, sillyPropOffset);
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final sillyPropParam = const fb.StringReader(
          asciiOptimization: true,
        ).vTableGet(buffer, rootOffset, 10, '');
        final object = EntityBMMock(
          id: idParam,
          createdAt: createdAtParam,
          updatedAt: updatedAtParam,
          sillyProp: sillyPropParam,
        );
