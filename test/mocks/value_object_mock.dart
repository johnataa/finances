...
class ValueObjectMock<T> extends ValueObject<T> {
  ...
  static Iterable<Validation> _validate<T>(T value, List<bool> isValidWhen) => isValidWhen.map(
    (isValid) => Validation(when: !isValid, pushError: ErrorMock.defaultInstance),
  );
}
