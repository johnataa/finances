...
final class AccountBox extends BaseBox<AccountBM, Account, AccountFilter, OrderBy<AccountField>>
    implements IAccountRepository {
  AccountBox(super.store, super.mapper);

  @override
  @protected
  QueryParser<AccountBM> parseQuery(AccountFilter? filter, OrderBy<AccountField>? orderBy) =>
      QueryParser(
        filter?.logic,
        [
